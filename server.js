...
function initData() {
  if (!fs.existsSync(path.join(DATA_DIR, 'banners.json'))) {
    saveData('banners', [
      { id: genId('bn_'), title: 'Welcome Bonus', imageUrl: 'https://i.ibb.co/hxyMYWyt/file-00000000192c8211bf1bcf496522a496.png', type: 'popup', position: 0, isActive: true, createdAt: new Date().toISOString() },
      { id: genId('bn_'), title: 'Home Banner', imageUrl: 'https://i.ibb.co/8DXd4d5D/file-00000000e284820bb3bcdcdc7654f7e9.png', type: 'home', position: 0, isActive: true, createdAt: new Date().toISOString() }
    ]);
  }
